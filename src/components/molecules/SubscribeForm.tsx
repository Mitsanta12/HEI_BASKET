...
import { Inscription } from "../particles/DataLists";
  ...
  return (
    <form className="flex md:flex-row flex-col items-stretch gap-2">
      <Input
        ...
        type="email"
        placeholder={Inscription.placeholderText}
      >
      ...
      <Button
        type="submit"
        className="border-none outline-none bg-color1 py-2 px-6 text-white font-light text-base rounded-lg"
      >
